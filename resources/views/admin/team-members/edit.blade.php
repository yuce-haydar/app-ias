        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Yönetim Kurulu Üyesi Düzenle</h3>
                </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('designation') is-invalid @enderror" 
                                           id="designation" name="designation" value="{{ old('designation', $teamMember->designation) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              id="description" name="description" rows="3">{{ old('description', $teamMember->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('education') is-invalid @enderror" 
                                              ...
                                              placeholder="Her satıra bir eğitim bilgisi yazın">{{ old('education', is_array($teamMember->education) ? implode("\n", $teamMember->education) : '') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('specialties') is-invalid @enderror" 
                                              ...
                                              placeholder="Her satıra bir uzmanlık alanı yazın">{{ old('specialties', is_array($teamMember->specialties) ? implode("\n", $teamMember->specialties) : '') }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('experience_years') is-invalid @enderror" 
                                           id="experience_years" name="experience_years" value="{{ old('experience_years', $teamMember->experience_years) }}" min="0">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control @error('social_facebook') is-invalid @enderror" 
                                           id="social_facebook" name="social_facebook" value="{{ old('social_facebook', $teamMember->social_facebook) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control @error('social_twitter') is-invalid @enderror" 
                                           id="social_twitter" name="social_twitter" value="{{ old('social_twitter', $teamMember->social_twitter) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control @error('social_linkedin') is-invalid @enderror" 
                                           id="social_linkedin" name="social_linkedin" value="{{ old('social_linkedin', $teamMember->social_linkedin) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control @error('social_instagram') is-invalid @enderror" 
                                           id="social_instagram" name="social_instagram" value="{{ old('social_instagram', $teamMember->social_instagram) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                           id="sort_order" name="sort_order" value="{{ old('sort_order', $teamMember->sort_order ?? 0) }}" min="0">
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="status" name="status" 
                                               value="1" {{ old('status', $teamMember->status) ? 'checked' : '' }}>
