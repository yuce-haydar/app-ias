                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="iframe-codes-container">
                                        @if($facility->iframe_codes && count($facility->iframe_codes) > 0)
                                            @foreach($facility->iframe_codes as $index => $iframe)
                                                <div class="iframe-item" data-index="{{ $index }}">
                                                    <div class="card border-info mb-3">
                                                        <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                                                            <span>İframe {{ $index + 1 }}</span>
                                                            <button type="button" class="btn btn-sm btn-outline-light remove-iframe" {{ $index === 0 && count($facility->iframe_codes) === 1 ? 'disabled' : '' }}>
...
let iframeIndex = {{ $facility->iframe_codes ? count($facility->iframe_codes) : 1 }};
