                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="iframe-codes-container">
                                        @if($project->iframe_codes && count($project->iframe_codes) > 0)
                                            @foreach($project->iframe_codes as $index => $iframe)
                                                <div class="iframe-item" data-index="{{ $index }}">
                                                    <div class="card border-info mb-3">
                                                        <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                                                            <span>İframe {{ $index + 1 }}</span>
                                                            <button type="button" class="btn btn-sm btn-outline-light remove-iframe" {{ $index === 0 && count($project->iframe_codes) === 1 ? 'disabled' : '' }}>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" 
                                                                       name="iframe_codes[{{ $index }}][title]" 
                                                                       value="{{ old('iframe_codes.'.$index.'.title', $iframe['title'] ?? '') }}" 
                                                                       placeholder="Örn: Proje Haritası, 360° Görünüm">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label">İframe Kodu</label>
                                                                <textarea class="form-control" 
                                                                          name="iframe_codes[{{ $index }}][code]" 
                                                                          rows="4" 
                                                                          placeholder="Örn: Google Maps embed kodu veya başka bir iframe kodu">{{ old('iframe_codes.'.$index.'.code', $iframe['code'] ?? '') }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                                    ...
                                                                    <textarea class="form-control" 
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <div class="form-check form-switch mt-2">
                                                                                    <input type="hidden" name="locations[{{ $index }}][show_location]" value="0">
                                                                                    <input type="checkbox" class="form-check-input" 
                                                                                           name="locations[{{ $index }}][show_location]" 
                                                                                           value="1" 
                                                                                           {{ old('locations.'.$index.'.show_location', $location->show_location ?? true) ? 'checked' : '' }}>
...
let iframeIndex = {{ $project->iframe_codes ? count($project->iframe_codes) : 1 }};
