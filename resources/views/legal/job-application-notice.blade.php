...
@section('title', 'İlan Başvuru Formu Aydınlatma Metni - Hatay İmar')
    ...
    <div class="container">
        <div class="title-outer">
            <div class="page-title">
                <h2 class="title">İlan Başvuru Formu Aydınlatma Metni</h2>
                <ul class="page-breadcrumb">
                    <li><a href="{{ route('home') }}">Ana Sayfa</a></li>
                    <li><a href="{{ route('legal') }}">KVKK</a></li>
                    <li>İlan Başvuru Formu Aydınlatma Metni</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="page-content">
                    <div class="content-section">
                        <h2>Hatay İmar Sanayi A.Ş. Kişisel Verilerin Korunması Kanunu Kapsamında İlan Başvuru Formu Bölümü Aydınlatma Metni</h2>
                        ...
                        <div class="giris-bilgi mb-4">
                            ...
                            <p>İşbu Aydınlatma Metni, 6698 Sayılı Kişisel Verilerin Korunması Kanunu'nun 10. Maddesi kapsamında, <strong>http://hatayimar.com.tr/</strong> internet sitesinin İlan Başvuru Formu Bölümüne istinaden başvurularınızı iletebilmek için bizimle paylaşabileceğiniz kişisel verileriniz ile ilgili olarak, veri sorumlusu sıfatıyla Hatay İmar tarafından, sizi aydınlatmak ve bilgilendirmek amacıyla hazırlanmıştır.</p>
                        </div>
                        ...
                        <div class="veri-isleme-amaci mb-4">
                            ...
                            <p>İnternet sitesi kullanıcılarının bizimle iletişime geçmesini sağlamak, kurumumuzun yayımladığı ilanlara ön başvuru yapabilmenize imkan tanımak ve bunu da mümkün olan en kolay şekilde sağlayabilmek amacıyla <strong>http://hatayimar.com.tr/</strong> alan adlı internet sitesinin İlan Başvuru Formu Bölümünde iletilerinizi bizimle paylaşabileceğiniz bir alan oluşturduk.</p>
                            
                            <p>İşbu alanda size hitap edebilmemiz ve iletinize konu hususu araştırabilmemiz için <strong>adınızı-soyadınızı</strong>, sizi tanıyabilmek ve başvuru sürecinizin takibini kolaylaştırabilmek için <strong>T.C. kimlik numaranızı</strong>, sizinle irtibat kurabilmek ve/veya iletiniz hakkında size bilgi vermek ya da iletinize cevap verebilmek için <strong>telefon numaranızı</strong> talep etmekte ve bizimle paylaştığınız kişisel verilerinizi iletinizde belirttiğiniz amaç doğrultusunda işlemekteyiz.</p>
                            
                            <p>Yine size daha iyi yardımcı olabilmek, başvurunuza en iyi cevabı verebilmek amacıyla başvurunuza konu hususu araştırabilir ve bu araştırmalarda elde ettiğimiz kişisel verilerinizi işleyebiliriz. Bu bölümde ayrıca başvurunuzun içeriğini bizimle paylaşabilmeniz amacıyla, konu alanı bulunmaktadır. Burada da bizimle paylaştığınız kişisel verileriniz iletiniz doğrultusunda işlenecektir.</p>
                        </div>
                        ...
                        <div class="veri-toplama-yontemi mb-4">
                            ...
                            <p>Kişisel verileriniz, <strong>http://hatayimar.com.tr/</strong> alan adlı internet sitesinin İlan Başvuru Formu Bölümünden paylaşılmanız suretiyle tamamen veya kısmen otomatik yolla işlenmektedir.</p>
                        </div>
