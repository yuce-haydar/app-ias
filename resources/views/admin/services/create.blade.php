                ...
                <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="mb-3">
                                    <label for="title" class="form-label">Hizmet Adı <span class="text-danger">*</span></label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Her satıra bir özellik yazarak liste oluşturabilirsiniz</small>
                                    @error('features')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Bu hizmetin sağladığı faydaları açıklayın</small>
                                    @error('benefits')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">FontAwesome ikon sınıfı</small>
                                    @error('icon')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('service_category') is-invalid @enderror" 
                                           id="service_category" name="service_category" value="{{ old('service_category') }}" 
                                           placeholder="Örn: İmar, Planlama, Danışmanlık" required>
...
<script>
let descriptionEditor, featuresEditor, benefitsEditor;
...
document.querySelector('form').addEventListener('submit', function(e) {
    ...
    if (benefitsEditor) {
        document.querySelector('#benefits').value = benefitsEditor.getData();
    }
